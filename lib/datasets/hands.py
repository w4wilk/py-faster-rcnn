...
# Modified by Lukasz Wilczynski, based on
...
class hands(imdb):
    def __init__(self, image_set, devkit_path):
        ...
        # inria # self._roidb_handler = self.selective_search_roidb
        ...
        self.config = {'cleanup'  : True,
                       ...
                       'top_k'    : 2000,
                       'use_diff' : False,
                       # 'matlab_eval': False,  # inria is missing this
                       # 'min_size': 2,  # inria is missing this
                       'rpn_file' : None}
    ...
    def image_path_from_index(self, index):
        ...
        assert os.path.exists(image_path), \
            'File with supported extension does ' \
            'not exist: {}'.format(image_path)
        return image_path
    ...
    def _load_image_set_index(self):
        ...
        assert os.path.exists(image_set_file), \
                'Image set path does not exist: {}'.format(image_set_file)
    ...
    def _load_hands_annotation(self, index):
        ...
        format.
        """
        # inria is loading from a txt file, I'm keeping the voc xml format
    ...
    def _get_hands_results_file_template(self):
        # HANDSdevkit/results/<comp_id>_det_{%s}.txt
